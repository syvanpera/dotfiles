...
complete -c workmux -n "__fish_workmux_needs_command" -f -a "_deferred-cleanup"
...
complete -c workmux -n "__fish_workmux_needs_command" -f -a "sidebar" -d 'Control a live agent status sidebar in tmux'
...
complete -c workmux -n "__fish_workmux_needs_command" -f -a "register-agent" -d 'Register the agent in the current multiplexer pane (used by hooks)'
...
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l worktree-path -r -F
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l branch-name -r
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l handle -r
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l device -r
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l inode -r
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l expected-worktree -r -F
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l admin-dir -r -F
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l common-dir -r -F
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l dot-git -r -F
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l source-mode -r -f -a "window\t''
session\t''"
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l source-name -r
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l parent-session -r
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l source-id -r
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l keep-branch
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -l force
complete -c workmux -n "__fish_workmux_using_subcommand _deferred-cleanup" -s h -l help -d 'Print help'
complete -c workmux -n "__fish_workmux_using_subcommand add" -l pr -d 'Pull/merge request number or full GitHub/GitLab URL to checkout' -r
complete -c workmux -n "__fish_workmux_using_subcommand add" -l forge -d 'Forge for numeric --pr references (auto-detects gitlab.com; otherwise GitHub)' -r -f -a "github\t''
gitlab\t''"
...
complete -c workmux -n "__fish_workmux_using_subcommand add" -s c -l continue -d 'Resume the agent\'s most recent conversation at the destination worktree path'
...
complete -c workmux -n "__fish_workmux_using_subcommand list" -l all -d 'List worktrees across repositories with tracked agents'
...
complete -c workmux -n "__fish_workmux_using_subcommand ls" -l all -d 'List worktrees across repositories with tracked agents'
...
complete -c workmux -n "__fish_workmux_using_subcommand status" -l all -d 'Report tracked agents across all repositories'
...
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -l position -d 'Sidebar placement when enabling' -r -f -a "left\t''
top\t''"
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -l width -d 'Sidebar width in columns or as a percentage, for example 40 or 15%' -r
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -l height -d 'Sidebar height in rows or as a percentage, for example 3 or 10%' -r
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -s s -l session -d 'Scope sidebar to this session, or toggle this session off when global sidebar is active'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -s h -l help -d 'Print help'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -f -a "on" -d 'Ensure the sidebar is running'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -f -a "off" -d 'Ensure the sidebar is stopped'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -f -a "next" -d 'Switch to the next agent in sidebar order'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -f -a "prev" -d 'Switch to the previous agent in sidebar order'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -f -a "jump" -d 'Jump to the Nth agent in sidebar order (1-indexed)'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -f -a "filter" -d 'Set sidebar filter mode. Toggles if no mode given'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and not __fish_seen_subcommand_from on off next prev jump filter help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and __fish_seen_subcommand_from on" -l position -d 'Sidebar placement when enabling' -r -f -a "left\t''
top\t''"
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and __fish_seen_subcommand_from on" -l width -d 'Sidebar width in columns or as a percentage, for example 40 or 15%' -r
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and __fish_seen_subcommand_from on" -l height -d 'Sidebar height in rows or as a percentage, for example 3 or 10%' -r
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and __fish_seen_subcommand_from on" -s h -l help -d 'Print help'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and __fish_seen_subcommand_from off" -s h -l help -d 'Print help'
...
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and __fish_seen_subcommand_from help" -f -a "on" -d 'Ensure the sidebar is running'
complete -c workmux -n "__fish_workmux_using_subcommand sidebar; and __fish_seen_subcommand_from help" -f -a "off" -d 'Ensure the sidebar is stopped'
...
complete -c workmux -n "__fish_workmux_using_subcommand register-agent" -s h -l help -d 'Print help'
...
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_deferred-cleanup"
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "add" -d 'Create a new worktree and tmux window'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "open" -d 'Open a tmux window for an existing worktree'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "close" -d 'Close a worktree\'s tmux window (keeps the worktree and branch)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "resurrect" -d 'Restore worktree windows after a tmux or computer crash'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "merge" -d 'Merge a branch, then clean up the worktree and tmux window'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "rebase" -d 'Rebase a worktree branch onto its base branch'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "rename" -d 'Rename a worktree, its tmux window/session, and (optionally) its branch'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "remove" -d 'Remove a worktree, tmux window, and branch without merging'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "list" -d 'List all worktrees'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "path" -d 'Get the filesystem path of a worktree'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "send" -d 'Send a prompt or instruction to a running agent'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "capture" -d 'Capture terminal output from a running agent'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "status" -d 'Query agent status for worktrees'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "wait" -d 'Wait for agents to reach a target status'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "run" -d 'Run a command in a worktree\'s window'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "reap-agents" -d 'Exit tracked agent processes older than a configured age'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "sync-files" -d 'Re-apply file operations (copy/symlink) to worktrees'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "init" -d 'Generate example .workmux.yaml configuration file'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "setup" -d 'Set up agent status tracking hooks and install skills'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "uninstall" -d 'Remove agent status tracking hooks, skills, and cache/state dirs'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "docs" -d 'Show detailed documentation (renders README.md)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "changelog" -d 'Show the changelog (what\'s new in each version)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "update" -d 'Update workmux to the latest version'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "sidebar" -d 'Control a live agent status sidebar in tmux'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_sidebar-run" -d 'Run the sidebar TUI (internal use)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_sidebar-sync" -d 'Sync sidebar into a window (internal use, called by tmux hooks)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_sidebar-reflow" -d 'Reflow sidebar layout after window resize (internal use, called by tmux hooks)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_sidebar-reflow-all" -d 'Reflow sidebar layouts in all windows (internal use, called by tmux hooks)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_sidebar-daemon" -d 'Run the sidebar daemon (internal use)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "dashboard" -d 'Show a TUI dashboard of all active workmux agents across all sessions'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "config" -d 'Manage global configuration'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "claude" -d 'Claude Code integration commands'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "sandbox" -d 'Manage sandbox settings'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "set-window-status" -d 'Set agent status for the current tmux window (used by hooks)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "register-agent" -d 'Register the agent in the current multiplexer pane (used by hooks)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "set-base" -d 'Set the base branch for the current worktree (used after rebasing)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_exec" -d 'Execute a run spec (internal use)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "last-done" -d 'Switch to the agent that most recently completed or is waiting for input'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "last-agent" -d 'Switch to the last visited agent (toggle between two)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "host-exec" -d 'Execute a command on the host (used by guest shims)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "clipboard-read" -d 'Read clipboard from host (used by sandbox clipboard shims)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "completions" -d 'Generate shell completions'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_complete-branches" -d 'Output worktree branch names for shell completion (internal use)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_complete-handles" -d 'Output worktree handles for shell completion (internal use)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_complete-git-branches" -d 'Output git branches for shell completion (internal use)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_complete-agent-targets" -d 'Output agent targets for shell completion (internal use)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "_check-update" -d 'Background update check (internal use)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and not __fish_seen_subcommand_from _deferred-cleanup add open close resurrect merge rebase rename remove list path send capture status wait run reap-agents sync-files init setup uninstall docs changelog update sidebar _sidebar-run _sidebar-sync _sidebar-reflow _sidebar-reflow-all _sidebar-daemon dashboard config claude sandbox set-window-status register-agent set-base _exec last-done last-agent host-exec clipboard-read completions _complete-branches _complete-handles _complete-git-branches _complete-agent-targets _check-update help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c workmux -n "__fish_workmux_using_subcommand help; and __fish_seen_subcommand_from sidebar" -f -a "on" -d 'Ensure the sidebar is running'
complete -c workmux -n "__fish_workmux_using_subcommand help; and __fish_seen_subcommand_from sidebar" -f -a "off" -d 'Ensure the sidebar is stopped'
