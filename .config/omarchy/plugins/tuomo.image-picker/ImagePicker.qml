        ...
        Item {
          ...
          Keys.onPressed: function(event) {
            if (event.key === Qt.Key_Escape) {
              ...
              event.accepted = true
            } else if (event.key === Qt.Key_Left || (event.key === Qt.Key_Tab && event.modifiers & Qt.ShiftModifier) || event.key === Qt.Key_Backtab || (event.key === Qt.Key_P && event.modifiers === Qt.ControlModifier)) {
              root.selectAdjacent(-1)
              event.accepted = true
            } else if (event.key === Qt.Key_Right || event.key === Qt.Key_Tab || (event.key === Qt.Key_N && event.modifiers === Qt.ControlModifier)) {
              root.selectAdjacent(1)
              event.accepted = true
