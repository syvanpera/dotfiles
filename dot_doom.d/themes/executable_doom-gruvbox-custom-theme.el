;;; doom-gruvbox-custom-custom-theme.el --- inspired by morhetz's Gruvbox -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(def-doom-theme doom-gruvbox-custom
  ...
  ((bg
   ...
   (fg         '("#fbf1c7" "#fbfbfb" "brightwhite")) ; fg/fg1
