...
descriptions=$(echo $sinks | jq -r '.[] | .description')
current_sink=$(echo $sinks | jq '.[] | select(.name == "alsa_output.usb-0b0e_Jabra_Link_380_08C8C256BE5C-00.analog-stereo")')
